...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] pb-24 md:pb-0">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 px-6 rounded-t-[2rem] shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-50 flex gap-4">
        <Button
          variant="outline"
